...
* The original package name 'com.golive.microservices.netflix-eureka-naming-server' is invalid and this project uses 'com.golive.microservices.netflixeurekanamingserver' instead.
